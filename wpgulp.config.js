...
const projectURL = 'localhost/brunopulis';
...
const textDomain = 'BrunoPulis';

// Name of the translation file.
const translationFile = 'BrunoPulis.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'BrunoPulis';

// Where can users report bugs.
const bugReport = 'https://github.com/brunopulis/brunopulis.com/issues/new?assignees=brunopulis&labels=bug&template=bug-report.md&title=BUG%3A+DESCRIBE+THE++BUG';
