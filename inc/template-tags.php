...
if ( ! function_exists( 'odin_posted_on' ) ) {
	...
	function odin_posted_on() {
		...
		printf( '<span class="byline">%s <span class="author vcard"><a class="url fn n" href="%s" rel="author">%s</a></span>.</span><span class="entry-date">%s <time class="entry-date" datetime="%s">%s</time></span>',
			__( 'Postado em:', 'odin' ),
